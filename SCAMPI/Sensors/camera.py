...
"""
    ...
    def capture_photo(self,auto=True,focus_length=10000000) :
        ...
        if auto :
                ...
                d=100/focus_length
                self.camera.set_controls({"AfMode": controls.AfModeEnum.Manual, "LensPosition": d})
        sleep(1)
...
if __name__ == '__main__':
    test = Camera()
    test.capture_photo(focus_length=100)
    #test.capture_photo(auto=False,focus_length=5)
    #test.capture_photo(auto=False, focus_length=0.05)
    #test.capture_video()
